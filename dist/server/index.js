globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-srdktjF_.js","assets/layout-segment-context-gnt0R3vG.js"];
...
function getDraftSecret() {
	return "51343d26-efb7-468b-a1a2-efd9658bef9e";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "6f9b3637-05a0-4d13-a39c-38bf721bed00";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "6f9b3637-05a0-4d13-a39c-38bf721bed00") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "6f9b3637-05a0-4d13-a39c-38bf721bed00",
		rootBoundaryId
	});
}
/**
